...
export const EN_GB_MESSAGES: Messages = {
  [DEFAULT_LOCALES.ENGLISH]: {
    ...
    "features.config.configurationsError": "Failed to load {featureId} configuration.",
    ...
    "features.berichten.berichtObjectTypeUrl": "Message Objecttype Url:",
    "features.openklant2": "OpenKlant 2",
    "features.taak": "Task",
    "features.taak.configuration": "Configuration",
    "features.taak.enable": "Enabled",
    ...
    "features.objectsapi.enable": "Enabled",
    ...
    "features.catalogiapi.enable": "Enabled",
    "features.catalogiapi.url": "Catalogi Api Url",
    "features.catalogiapi.clientid": "Catalogi Api Client Id",
    "features.catalogiapi.secret": "Catalogi Api Secret",
    "features.catalogiapi.rsin": "Catalogi Api RSIN",
    "features.catalogiapi.documentTypeUrl": "Catalogi Api Document Type Url",
    "featureDetailPage.title": "Feature Configuration",
