...
export const EN_GB_MESSAGES: Messages = {
  [DEFAULT_LOCALES.ENGLISH]: {
    ...
    "features.zakenapi.url": "ASD",
    "features.zakenapi.url.description": "ASD",
    "features.zakenapi.client-id": "ASD",
    "features.zakenapi.client-id.description": "ASD",
    "features.zakenapi.secret": "ASD",
    "features.zakenapi.secret.description": "ASD",
    "features.zakenapi.vertrouwelijkheidsaanduiding-whitelist": "ASD",
    "features.zakenapi.vertrouwelijkheidsaanduiding-whitelist.description": "ASD",
    "features.zakenapi.status-whitelist": "ASD",
    "features.zakenapi.status-whitelist.description": "ASD",
    "features.documentenapi": "Documenten API",
    "features.documentenapi.configuration": "Configuration",
    "features.documentenapi.url": "ASD",
    "features.documentenapi.url.description": "ASD",
    "features.documentenapi.client-id": "ASD",
    "features.documentenapi.client-id.description": "ASD",
    "features.documentenapi.secret": "ASD",
    "features.documentenapi.secret.description": "ASD",
    "zaakdocument.vertrouwelijkheidsaanduiding.openbaar": "ASD",
    "zaakdocument.vertrouwelijkheidsaanduiding.beperkt_openbaar": "ASD",
    "zaakdocument.vertrouwelijkheidsaanduiding.intern": "ASD",
    "zaakdocument.vertrouwelijkheidsaanduiding.zaakvertrouwelijk": "ASD",
    "zaakdocument.vertrouwelijkheidsaanduiding.vertrouwelijk": "ASD",
    "zaakdocument.vertrouwelijkheidsaanduiding.confidentieel": "ASD",
    "zaakdocument.vertrouwelijkheidsaanduiding.geheim": "ASD",
    "zaakdocument.vertrouwelijkheidsaanduiding.zeer_geheim": "ASD",
    "zaakdocument.status.ter_vaststelling": "ASD",
    "zaakdocument.status.in_bewerking": "ASD",
    "zaakdocument.status.definitief": "ASD",
    "zaakdocument.status.gearchiveerd": "ASD",
  },
};
