...
export const EN_GB_MESSAGES: Messages = {
    [DEFAULT_LOCALES.ENGLISH]: {
        ...
        "configuration.subtitle": "This is where you can configure the various features of NL Portal.",
        "configuration.configure": "Configure",
        "configuration.features": "Features",
        "configuration.theme": "Theme Configuration",
        "features.config.loading-error": "Failed to load {featureId} configuration.",
        ...
        "theme.logo.existing-logos.description": "This is the existing theme logo configuration for the current NL Portal application",
        "theme.logo.label": "Logo",
        "theme.logo.description": "The Logo that is being served to this application",
        "theme.logo.upload-theme-logo.label": "Upload a Logo",
        "theme.logo.upload-theme-logo.description": "Upload an image file to use as the logo of the current NL Portal application.",
        "theme.logo.select-file": "Select File",
        "theme.logo.no-existing-logos": "No logo found for current NL Portal application",
        "theme.style": "Theme Style",
        "theme.style.add-theme-style.label": "Add Theme Style",
        "theme.style.add-theme-style.description": "Add a new theme style configuration for the current NL Portal application",
        "theme.style.add-another": "Add a theme style",
        "theme.style.existing-styles": "Existing Theme Style",
        "theme.style.existing-styles.description": "This is the existing theme style configuration for the current NL Portal application",
        "theme.style.stylesheet.label": "Stylesheet",
        "theme.style.stylesheet.description": "Define your styles or override style tokens. <linkUrl>Click here</linkUrl> to see a list of all available NLDS tokens.",
        "theme.style.no-existing-styles": "No style found for current NL Portal application",
        ...
        "features.haalcentraal2.brp-api-url.description": "The base url of the HaalCentraal 2 BRP API",
        "features.haalcentraal2.bewoning-api-url": "HaalCentraal 2 Bewoning Api Url",
        "features.haalcentraal2.bewoning-api-url.description": "The base url of the HaalCentraal 2 Bewoning API",
        "features.haalcentraal2.api-key": "HaalCentraal 2 Api Key",
        "features.haalcentraal2.api-key.description": "The secret that should be used for authenticating requests",
        "features.taak": "Task",
        ...
        "features.zakenapi.zaak-types-ids-excluded.description": "Exclude zaaktype uuid's as extra filter on the get zaken query.",
        ...
        "features.payment.ogone.url.description": "The baseurl of the to use Ogone Payment API",
        "features.payment.ogone.sha-out-parameters": "SHA-OUT parameters",
        "features.payment.ogone.sha-out-parameters.description": "The payment return parameters that should be validated",
        "features.payment.ogone.title": "Title",
        "features.payment.ogone.title.description": "A human readable title for the payment requests",
        "features.payment.ogone.psp-id": "PSPID",
        "features.payment.ogone.psp-id.description": "The payment service provider ID for your Ogone account",
        "features.payment.ogone.language": "Language",
        "features.payment.ogone.language.description": "The Language that should be used for the Checkout",
        "features.payment.ogone.sha-in-key": "SHA-IN Key",
        "features.payment.ogone.sha-in-key.description": "The secret key used to encrypt the fields in the payment request",
        "features.payment.ogone.sha-out-key": "SHA-OUT Key",
        "features.payment.ogone.sha-out-key.description": "The secret key used to validate payment fields in a payment callback",
        "features.payment.ogone.sha-version": "SHA Version",
        "features.payment.ogone.sha-version.description": "Which SHA version to use for encoding and validating payments",
        "features.payment.ogone.failure-url": "Failure URL",
        "features.payment.ogone.failure-url.description": "The URL Ogone should redirect to in case of a negative result (decline, cancel, exception...)",
        "features.payment.ogone.success-url": "Success URL",
        "features.payment.ogone.success-url.description": "The URL Ogone should redirect to in case of a positive result (accept)",
        "features.payment.ogone.profiles.add-another": "Add another",
        "features.payment.ogone.profiles.add-another.description": "Add another payment profile",
        "features.payment.ogone.profiles.profile-name": "example-ogone-payment-profile",
        ...
        "features.payment.direct.url.description": "The Online Payments platform API endpoint",
        "features.payment.direct.sha-out-parameters": "SHA-OUT parameters",
        "features.payment.direct.sha-out-parameters.description": "The payment return parameters that should be validated",
        "features.payment.direct.webhook-url": "Webhook URL",
        "features.payment.direct.webhook-url.description": "The URL where the webhook will be dispatched for all status change events related to this payment",
        "features.payment.direct.title": "Title",
        "features.payment.direct.title.description": "A human readable title for the payment requests",
        "features.payment.direct.psp-id": "PSPID",
        "features.payment.direct.psp-id.description": "The payment service provider ID (merchant ID) for your Direct account",
        "features.payment.direct.language": "Language",
        "features.payment.direct.language.description": "The Language that should be used for the Checkout",
        "features.payment.direct.currency": "Currency",
        "features.payment.direct.currency.description": "The currency that should be used for this payment profile denoted in the ISO 4217 standard",
        "features.payment.direct.return-url": "Return URL",
        "features.payment.direct.return-url.description": "The URL Direct should redirect to after checkout",
        "features.payment.direct.api-key": "API Key Id",
        "features.payment.direct.api-key.description": "The id used for authorization",
        "features.payment.direct.api-secret": "API Secret",
        "features.payment.direct.api-secret.description": "The secret used for authorization",
        "features.payment.direct.webhook-api-key": "Webhook API Key ID",
        "features.payment.direct.webhook-api-key.description": "The ID of the Webhook Key used to validate messages sent from Direct Webhooks",
        "features.payment.direct.webhook-api-secret": "Webhook API Secret",
        "features.payment.direct.webhook-api-secret.description": "The Webhook Key Secret used to validate messages sent from Direct Webhooks",
        ...
        "features.virusscan.clamav.hostname.description": "The hostname of the ClamAV service",
        "features.virusscan.clamav.port": "Port",
        "features.virusscan.clamav.port.description": "The port the ClamAV service listens on",
