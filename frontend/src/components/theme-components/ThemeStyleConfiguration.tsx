...
const ThemeStyleConfiguration = () => {
    ...
    const {
        ...
        createThemeStyle: {
            mutate: createThemeStyle,
        },
        updateThemeStyle: {
            data: updateThemeStylesData,
            mutate: updateThemeStyle,
        },
        deleteThemeStyle: {
            mutate: deleteThemeStyle,
        }
    } = useThemeStyle();
    ...
    const handleUpdateThemeStyle =
        (styleId: string, styles: string) => {
                        ...
                        {getThemeStylesData && !getThemeStylesData.find(style => style.application === clientSettings.applicationName) &&
                            ...
                            >
                                <FormField
                                    label={
                                        <FormLabel>
                                            <FormattedMessage id={"theme.style.add-theme-style.label"}/>
                                        </FormLabel>
                                    }
                                    description={
                                        <Paragraph>
                                    ...
                                    getThemeStylesData?.map((themeStyle, index) => (
                                        ...
                                        >
                                            <FormField>
                                                <ActionField
                                                    ...
                                                    button={
                                                        <IconButton
                                                            type={"button"}
                                                            onClick={() => handleDeleteThemeStyle(themeStyle.styleId)}
                                                        >
                                                            <TrashIcon></TrashIcon>
                                                        </IconButton>
                                                    }
                                            ...
                                            <FormField
                                                label={
                                                    <Heading4>
                                                        <FormattedMessage id={"theme.style.stylesheet.label"}/>
                                                    </Heading4>
                                                }
                                                description={
                                                    <Paragraph>
                                            ...
                                            >
                                                <Editor
                                                    value={dirtyStyles || updateThemeStylesData?.styles || getThemeStylesData[0]?.styles}
                                            ...
                                            <div className={styles["feature-config__buttons"]}>
                                                <Button
                                                    ...
                                                    onClick={() => handleUpdateThemeStyle(themeStyle.styleId, dirtyStyles!)}
                                                >
