      ...
      <ConfigurationForm
        ...
        children={
          <>
            ...
            {themeLogos &&
              !themeLogos.find(
                (logo) => logo.application === clientSettings.applicationName,
              ) && (
                <section
                ...
                >
                  <FormField
                    label={
                      <FormLabel>
                        <FormattedMessage
                          id={"theme.logo.upload-theme-logo.label"}
                        />
                      </FormLabel>
                    }
                    description={
            ...
            {currentLogos.length > 0 && (
              <>
                <FieldsetLegend className="utrecht-form-fieldset__legend--distanced">
                  ...
                  <Paragraph>
                    <FormattedMessage
                      id={"theme.logo.existing-logos.description"}
                    />
                  </Paragraph>
                </FieldsetLegend>
                {currentLogos?.map((logo, index) => (
                  ...
                  >
                    ...
                    <FormField
                      ...
                      description={
                        <Paragraph>
                          <FormattedMessage id={"theme.logo.description"} />
                        </Paragraph>
                      }
                      key={`logo-${index}`}
                    >
