...
interface HaalCentraal2FeatureConfigurationProps extends FeatureConfigurationProps {
...
const HaalCentraal2FeatureConfiguration = ({
    ...
    const [currentConfiguration, setCurrentConfiguration] = useState<HaalCentraal2Configuration>(prefillConfiguration || {})
    const {
        register,
        watch,
        reset,
