                                                               ...
                                                               >
                                                                   {
                                                                       languages.map(lang =>
                                                                           ...
                                                                           >
                                                                               <FormattedMessage
                                                                                   id={"i18n.language." + lang}></FormattedMessage>
                                                                           </SelectOption>
                                                                       )
                                                           ...
                                                           <FormField
                                                               label={
                                                                   <FormLabel htmlFor={"sha-version"}>
                                                                       <FormattedMessage id={"features.payment.ogone.sha-version"}/>
                                                                   </FormLabel>
                                                               }
                                                               description={
                                                                   <Paragraph>
                                                           ...
                                                           <FormField
                                                               label={
                                                                   <FormLabel htmlFor={"failure-url"}>
                                                                       <FormattedMessage id={"features.payment.ogone.failure-url"}/>
                                                                   </FormLabel>
                                                               }
                                                               description={
                                                                   <Paragraph>
                                                           ...
                                                           <FormField
                                                               label={
                                                                   <FormLabel htmlFor={"success-url"}>
                                                                       <FormattedMessage id={"features.payment.ogone.success-url"}/>
                                                                   </FormLabel>
                                                               }
                                                               description={
                                                                   <Paragraph>
