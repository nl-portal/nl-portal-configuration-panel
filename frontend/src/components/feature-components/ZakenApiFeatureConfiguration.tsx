...
const ZakenApiFeatureConfiguration = ({
    ...
    const [currentConfiguration, setCurrentConfiguration] = useState<ZakenApiConfiguration>(prefillConfiguration || {})
    const documentStatussen = Object.values(DocumentStatus)
    const documentVertrouwelijkheidsaanduidingen = Object.values(Vertrouwelijkheidsaanduiding)
    const {
        register,
        watch,
        reset,
                               ...
                               <Fragment>
                                   <FieldsetLegend className="utrecht-form-fieldset__legend--distanced">
                                       <Heading3><FormattedMessage
                                           id={"features.zakenapi.configuration"}></FormattedMessage></Heading3>
                                   </FieldsetLegend>
                                   ...
                                   {watch("enabled") === "true" && (
                                       <Fragment>
                                               ...
                                               >
                                                   {
                                                       documentVertrouwelijkheidsaanduidingen.map(aanduiding =>
                                                           ...
                                                           >
                                                               <FormattedMessage
                                                                   id={"zaakdocument.vertrouwelijkheidsaanduiding." + aanduiding}></FormattedMessage>
                                                           </SelectOption>
                                                       )
                                           ...
                                           <FormField
                                               ...
                                               <Select className={styles["form-field__select"]}
                                                       {...register("properties.zaak-documenten-config.status-whitelist")}
                                                       id="status-whitelist"
                                                       multiple
                                               >
                                                   {
                                                       documentStatussen.map(status =>
                                                           ...
                                                           >
                                                               <FormattedMessage
                                                                   id={"zaakdocument.status." + status}></FormattedMessage>
                                                           </SelectOption>
                                                       )
