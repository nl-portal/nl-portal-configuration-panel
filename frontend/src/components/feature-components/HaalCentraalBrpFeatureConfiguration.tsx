...
interface HaalCentraalBrpFeatureConfigurationProps extends FeatureConfigurationProps {
...
const HaalCentraalBrpFeatureConfiguration = ({
    ...
    const [currentConfiguration, setCurrentConfiguration] = useState<HaalCentraalBrpConfiguration>(prefillConfiguration || {})
    const {
        register,
        watch,
        reset,
                               ...
                               <Fragment>
                                   <FieldsetLegend className="utrecht-form-fieldset__legend--distanced">
                                       <Heading3><FormattedMessage
                                           id={"features.haalcentraal-brp.configuration"}></FormattedMessage></Heading3>
                                   </FieldsetLegend>
                                           ...
                                           <FormField
                                               label={
                                                   <FormLabel htmlFor={"url"}>
                                                       <FormattedMessage
                                                           id={"features.haalcentraal-brp.url"}/>
                                                   </FormLabel>
                                               }
                                               description={
                                                   <Paragraph>
