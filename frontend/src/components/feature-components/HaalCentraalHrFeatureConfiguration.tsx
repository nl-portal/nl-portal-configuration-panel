...
interface HaalCentraalHrFeatureConfigurationProps extends FeatureConfigurationProps {
...
const HaalCentraalHrFeatureConfiguration = ({
    ...
    const [currentConfiguration, setCurrentConfiguration] = useState<HaalCentraalHrConfiguration>(prefillConfiguration || {})
    const {
        register,
        watch,
        reset,
                               ...
                               <Fragment>
                                   <FieldsetLegend className="utrecht-form-fieldset__legend--distanced">
                                       <Heading3><FormattedMessage
                                           id={"features.haalcentraal-hr.configuration"}></FormattedMessage></Heading3>
                                   </FieldsetLegend>
                                           ...
                                           <FormField
                                               label={
                                                   <FormLabel htmlFor={"url"}>
                                                       <FormattedMessage
                                                           id={"features.haalcentraal-hr.url"}/>
                                                   </FormLabel>
                                               }
                                               description={
                                                   <Paragraph>
