...
const BesluitenApiFeatureConfiguration = ({
    ...
    const [currentConfiguration, setCurrentConfiguration] = useState<BesluitenApiConfiguration>(prefillConfiguration || {})
    const {
        register,
        watch,
        reset,
    ...
    } = useForm<BesluitenApiConfiguration>({defaultValues: {...prefillConfiguration, enabled: "false"}})
                               ...
                               <Fragment>
                                   <FieldsetLegend className="utrecht-form-fieldset__legend--distanced">
                                       <Heading3><FormattedMessage
                                           id={"features.besluitenapi.configuration"}></FormattedMessage></Heading3>
                                   </FieldsetLegend>
