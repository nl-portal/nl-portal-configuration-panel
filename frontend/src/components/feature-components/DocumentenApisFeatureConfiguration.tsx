...
interface DocumentenApiFeatureConfigurationProps
...
const DocumentenApisFeatureConfiguration = ({
  ...
  const [currentConfiguration, setCurrentConfiguration] = useState<
    DocumentenApisConfiguration | undefined
  >(prefillConfiguration);
  ...
  const addAnotherValid = () => {
    return (
      (!!addConfigurationRef &&
        ...
        !configurationEntries.find(
          (key) => addConfigurationRef.current?.value === key,
        )) ||
      false
    );
  };
          ...
          <Fragment>
            {configurationEntries.map((key, index) => (
              ...
              >
                        ...
                        onClick={() => {
                          setCurrentConfiguration(
                            _.omit(
                              getFormValue(),
                              `properties.configurations.${key}`,
                              `properties.default-document-api`,
                            ),
                          );
                        }}
                      >
                ...
                <FormField
                  label={
                    <FormLabel htmlFor={key + ".url"}>
                      <FormattedMessage id={"features.documentenapis.url"} />
                    </FormLabel>
                  }
                  description={
                    <Paragraph>
                ...
                <FormField
                  label={
                    <FormLabel htmlFor={"secret"}>
                      <FormattedMessage id={"features.documentenapis.secret"} />
                    </FormLabel>
                  }
                  description={
                    <Paragraph>
                ...
                <FormField
                  label={
                    <FormLabel htmlFor={key + ".rsin"}>
                      <FormattedMessage id={"features.documentenapis.rsin"} />
                    </FormLabel>
                  }
                  description={
                    <Paragraph>
                ...
                >
                  <TextInput
                    {...register(
                      `properties.configurations.${key}.document-type-url`,
                    )}
                    id={key + ".document-type-url"}
                    placeholder={
                      "https://example.com/catalogi/api/v1/informatieobjecttypen/00000000"
                    }
                    type="url"
                  />
                </FormField>
                ...
                field={
                  <TextInput
                    ...
                    placeholder={intl.formatMessage({
                      id: "features.documentenapis.configurations.configuration-name",
                    })}
                  />
                }
                button={
            ...
            {configurationEntries.length > 0 && (
              ...
              >
                ...
                >
                  {Object.keys(watch("properties.configurations") || {}).map(
                    (configurationName, index) => (
                      <SelectOption
